...
#ifndef _HEAVYBAG_SPOOF_H_INCLUDED_
#define _HEAVYBAG_SPOOF_H_INCLUDED_
...
ngx_int_t ngx_http_heavybag_spoof_init(ngx_conf_t *cf);


#endif /* _HEAVYBAG_SPOOF_H_INCLUDED_ */
